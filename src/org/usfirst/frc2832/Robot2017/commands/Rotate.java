...
public class Rotate extends Command {
	...
	protected void execute() {
		...
		if (Math.abs(error) <= arrivalThreshold) {
			...
			// turn fast
			Robot.driveTrain.tankDrive(direction * fastRotateSpeed, -direction * fastRotateSpeed);
		} else {
			// turn slow
			Robot.driveTrain.tankDrive(direction * slowRotateSpeed, -direction * slowRotateSpeed);
		}
		maxCycles--;
	}
