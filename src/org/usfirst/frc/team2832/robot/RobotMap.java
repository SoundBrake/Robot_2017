...
public class RobotMap {
	...
	public static final int rightEncoderChannelB=4;
	
	//rangefinder
	public static final int rangefinderChannel=6;
	
	//AnalogGyro
	public static final int analogGyroChannel=7;
	
	//joystick channel
	public static final int leftSpeedStickNumber=1;
	public static final int rightSpeedStickNumber=4;
